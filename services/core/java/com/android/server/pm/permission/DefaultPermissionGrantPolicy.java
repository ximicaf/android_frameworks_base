...
final class DefaultPermissionGrantPolicy {
    ...
    private void grantDefaultSystemHandlerPermissions(PackageManagerWrapper pm, int userId) {
        ...
        // Google Prebuilt Wallpaper Picker
        grantSystemFixedPermissionsToSystemPackage(pm, "com.android.wallpaper.livepicker", userId,
                WALLPAPER_PERMISSIONS);

        // Flipendo
        grantSystemFixedPermissionsToSystemPackage(pm,
                getDefaultProviderAuthorityPackage("com.google.android.flipendo", userId), userId,
